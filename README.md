...
```html
<script src="https://cdn.jsdelivr.net/gh/trilokyadav/ai-summary-widget@v1.0.3/dist/widget.min.js"></script>
```
...
| `data-color-theme` | Color theme of the widget — `light`, `dark`, or `auto` (auto-detects from the host page's actual background) | `auto` |
| `data-icon-size` | Icon button size — `sm` (32px), `md` (38px), or `lg` (44px) | `md` |
| `data-icon-style` | How brand icons render — `mono` (single neutral color) or `color` (full brand colors) | `color` |
...
```html
<script src="https://cdn.jsdelivr.net/gh/trilokyadav/ai-summary-widget@v1.0.3/dist/widget.min.js"
...
- Free CDN delivery powered by [jsDelivr](https://www.jsdelivr.com/)
- Sponsored by [U2L AI](https://u2l.ai?utm_source=ai-summary-widget&utm_medium=sponsor&utm_campaign=github-readme)
