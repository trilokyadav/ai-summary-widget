...
```html
<script src="https://cdn.jsdelivr.net/gh/trilokyadav/ai-summary-widget@v1.0.2/dist/widget.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/gh/trilokyadav/ai-summary-widget@v1.0.2/dist/widget.min.js"
